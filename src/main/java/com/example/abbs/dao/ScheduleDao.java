...
public interface ScheduleDao {
	...
	List<Schedule> getSchedule(String uid, String startDay, String endDay);
	...
	@Update("updqte schedule set sdate=#{sdate}, title=#{title}, place=#{place},"
			+" startTime=#{startTime}, endTime=#{endTime}, #{isImportant}, "
